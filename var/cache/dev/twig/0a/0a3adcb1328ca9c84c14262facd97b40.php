...
class __TwigTemplate_8cb934b6233dafff03c2a065810c9d52 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"text-center\" style=\"  margin-top: 50px;\">
        ...
        echo "'\">Create new Gallery</button>
...
";
    ...
    {
        return array (  134 => 40,  128 => 36,  119 => 32,  109 => 27,  104 => 25,  99 => 23,  95 => 22,  92 => 21,  87 => 20,  68 => 3,  58 => 2,  35 => 1,);
    }
    ...
    <table class=\"table\">
        ...
        {% for galery in galeries %}
            <tr>
                ...
                <td>
                <button class=\"btn btn-primary\" onclick=\"window.location.href='{{ path('app_galeries_show', {'idGalerie': galery.idGalerie}) }}'\">Show</button>
...
<div class=\"text-center\" style=\"  margin-top: 50px;\">
                                   ...
                                   <button class=\"btn btn-primary\" onclick=\"window.location.href='{{ path('app_galeries_new') }}'\">Create new Gallery</button>
...
{% endblock %}", "galeries/index.html.twig", "C:\\Users\\miral\\OneDrive\\Bureau\\PidevRania\\templates\\galeries\\index.html.twig");
    }
}
