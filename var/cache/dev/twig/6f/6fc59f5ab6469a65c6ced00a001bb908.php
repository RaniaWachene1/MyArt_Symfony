...
class __TwigTemplate_d5e34f1140a8caf465069baa51be6676 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<button class=\"block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04\" onclick=\"window.location.href='";
            // line 251
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_articles_quick_view", ["id" => twig_get_attribute($this->env, $this->source, $context["article"], "idArticle", [], "any", false, false, false, 251)]), "html", null, true);
...
\t\t\t\t\t\t\t\t\t";
            // line 257
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["article"], "titreArticle", [], "any", false, false, false, 257), "html", null, true);
            echo "
\t\t\t\t\t\t\t\t</a>
...
\t\t\t\t\t\t\t\t\t";
            // line 261
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["article"], "prixArticle", [], "any", false, false, false, 261), "html", null, true);
            echo " TND
\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t<div class=\"fs-18 cl11\">
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                // line 274
                echo "        ";
                if (($context["i"] <= twig_get_attribute($this->env, $this->source, $context["article"], "rate", [], "any", false, false, false, 274))) {
                    // line 275
                    echo "            <i class=\"item-rating pointer zmdi zmdi-star\"></i>
        ";
                } else {
                    // line 277
...
";
    ...
    {
        return array (  429 => 288,  416 => 280,  410 => 279,  406 => 277,  402 => 275,  399 => 274,  395 => 273,  387 => 268,  383 => 267,  374 => 261,  367 => 257,  358 => 251,  354 => 249,  348 => 247,  339 => 243,  336 => 242,  334 => 241,  329 => 239,  324 => 238,  322 => 237,  315 => 232,  311 => 231,  91 => 13,  82 => 10,  79 => 9,  75 => 8,  68 => 3,  58 => 2,  35 => 1,);
    }
...
\t\t\t\t\t\t\t<button class=\"block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04\" onclick=\"window.location.href='{{ path('app_articles_quick_view',{'id':article.idArticle}) }}'\">Quick View</button>
\t\t\t\t\t\t</div>
...
\t\t
{% endblock %}", "articles/indexfront.html.twig", "C:\\Users\\rania\\Downloads\\PidevRania1.0\\templates\\articles\\indexfront.html.twig");
    }
}
