...
class __TwigTemplate_bf8908c8112c92fc466668adb2c7ee00 extends Template
{
    private $source;
    private $macros = [];
...
$context["article"], "photoArticle", [], "any", false, false, false, 35)))) {
            ...
            echo "</td>
                <td>
                  <button class=\"btn btn-info btn-sm  \" style=\"  margin-left: 20px;\" onclick=\"window.location.href='";
            // line 46
...
<button class=\"btn btn-primary\"  onclick=\"window.location.href='";
        ...
        echo "'\"> <i class=\"bi bi-plus\"></i>Create new Article </button>
...
";
    ...
    {
        return array (  199 => 74,  193 => 71,  179 => 60,  174 => 57,  165 => 53,  155 => 48,  150 => 46,  145 => 44,  142 => 43,  136 => 41,  127 => 37,  124 => 36,  122 => 35,  117 => 33,  112 => 32,  110 => 31,  104 => 28,  100 => 27,  96 => 25,  91 => 24,  68 => 3,  58 => 2,  35 => 1,);
    }
    ...
    <table class=\"table\">
        ...
        {% for article in articles %}
            <tr>
                ...
                <td>
                  <button class=\"btn btn-info btn-sm  \" style=\"  margin-left: 20px;\" onclick=\"window.location.href='{{ path('app_articles_show', {'idArticle': article.idArticle}) }}'\"> Show <i class=\"bi bi-eye\"></i></button>
<div  style=\"margin-top: 10px;\">     </div> 
                 <button class=\"btn btn-info btn-sm  \" style=\"  margin-left: 20px;\" onclick=\"window.location.href='{{ path('app_articles_edit', {'idArticle': article.idArticle}) }}'\">Edit <i class=\"bi bi-pencil-square\"></i></button>
    ...
    <div class=\"text-center\" style=\"  margin-top: 50px;\">
<button class=\"btn btn-primary\"  onclick=\"window.location.href='{{ path('app_articles_new') }}'\"> <i class=\"bi bi-plus\"></i>Create new Article </button>
...
{% endblock %}
", "articles/index.html.twig", "C:\\Users\\rania\\Downloads\\PidevRania1.0\\templates\\articles\\index.html.twig");
    }
}
