...
class __TwigTemplate_16038078300ab190e0900851fbe7b408 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_tableForm($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1>Edit Galeries</h1>

    ";
        // line 8
        echo twig_include($this->env, $context, "galeries/_form.html.twig", ["button_label" => "Update"]);
        echo "
...
{% block tableForm %}
    ...
    {{ include('galeries/_form.html.twig', {'button_label': 'Update'}) }}

    <a href=\"{{ path('app_galeries_index') }}\">back to list</a>

    {{ include('galeries/_delete_form.html.twig') }}
{% endblock %}
", "galeries/edit.html.twig", "C:\\Users\\rania\\my_project_directory\\templates\\galeries\\edit.html.twig");
    }
}
