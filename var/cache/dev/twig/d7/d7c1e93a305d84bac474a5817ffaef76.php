...
class __TwigTemplate_995716d8b5339d837902443c6e8ccd8a extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["galery"]) {
            ...
            echo "</td>
                <td>
                <button class=\"btn btn-warning btn-sm  \" style=\"  margin-left: 60px;\" onclick=\"window.location.href='";
            // line 25
            ...
            echo "'\">Show <i class=\"bi bi-eye\"></i></button>
                    ...
                    <button class=\"btn btn-success btn-sm  \" style=\"  margin-left: 30px;\" onclick=\"window.location.href='";
            // line 27
    ...
    <table class=\"table\">
        ...
        {% for galery in galeries %}
            <tr>
                ...
                <td>
                <button class=\"btn btn-warning btn-sm  \" style=\"  margin-left: 60px;\" onclick=\"window.location.href='{{ path('app_galeries_show', {'idGalerie': galery.idGalerie}) }}'\">Show <i class=\"bi bi-eye\"></i></button>

                    <button class=\"btn btn-success btn-sm  \" style=\"  margin-left: 30px;\" onclick=\"window.location.href='{{ path('app_galeries_edit', {'idGalerie': galery.idGalerie}) }}'\">Edit <i class=\"bi bi-pencil-square\"></i></button>
...
{% endblock %}", "galeries/index.html.twig", "C:\\Users\\miral\\OneDrive\\Bureau\\PidevRania1.0\\templates\\galeries\\index.html.twig");
    }
}
