...
class __TwigTemplate_b1656857b734c1e550d8b9f8d26481ca extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  125 => 37,  118 => 34,  112 => 32,  110 => 31,  105 => 29,  101 => 28,  93 => 23,  86 => 19,  68 => 3,  58 => 2,  35 => 1,);
    }
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ galery.titreGalerie }}</td>
                   ...
                   <div class=\"button-container\">
  <button class=\"btn btn-primary\" onclick=\"window.location.href='{{ path('app_galeries_index') }}'\">Back to List</button>
  <button class=\"btn btn-primary\" onclick=\"window.location.href='{{ path('app_galeries_edit', {'idGalerie': galery.idGalerie}) }}'\">Edit</button>
<div class=\"text-center\" style=\"  margin-top: 50px;\">
{% if articles is empty %}
 {{ include('galeries/_delete_form.html.twig') }}
               {% else %}
                    <button class=\"btn btn-primary\" onclick=\"window.location.href='{{ path('app_galeries_delete1',{'idGalerie': galery.idGalerie}) }}'\">Delete</button>               
...
{% endblock %}
", "galeries/show.html.twig", "C:\\Users\\miral\\OneDrive\\Bureau\\PidevRania\\templates\\galeries\\show.html.twig");
    }
}
