...
class __TwigTemplate_23c187adadaea18dadc04d76a0f3ca93 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
                   ...
                   <div class=\"button-container\" style=\"  margin-top: 20px;\">
                     <button class=\"btn btn-info btn-sm \" style=\"  margin-left: 210px;\" onclick=\"window.location.href='";
        // line 28
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ galery.titreGalerie }}</td>
                   ...
                   <div class=\"button-container\" style=\"  margin-top: 20px;\">
                     <button class=\"btn btn-info btn-sm \" style=\"  margin-left: 210px;\" onclick=\"window.location.href='{{ path('app_galeries_edit', {'idGalerie': galery.idGalerie}) }}'\">Edit <i class=\"bi bi-pencil-square\"></i></button>
...
{% endblock %}
", "galeries/show.html.twig", "C:\\Users\\rania\\OneDrive\\Documents\\MyArt_Symfony\\templates\\galeries\\show.html.twig");
    }
}
