...
class __TwigTemplate_3ea19be7787cbc2414ec87b650c75821 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["panier"]) {
            ...
            echo "            <tr>
                <td>";
            // line 19
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["panier"], "idPanier", [], "any", false, false, false, 19), "html", null, true);
            echo "</td>
                <td>";
            // line 20
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["panier"], "total", [], "any", false, false, false, 20), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 22
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_panier_show", ["idPanier" => twig_get_attribute($this->env, $this->source, $context["panier"], "idPanier", [], "any", false, false, false, 22)]), "html", null, true);
            echo "\">show</a>
                    <a href=\"";
            // line 23
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_panier_edit", ["idPanier" => twig_get_attribute($this->env, $this->source, $context["panier"], "idPanier", [], "any", false, false, false, 23)]), "html", null, true);
            echo "\">edit</a>
                </td>
            </tr>
        ";
...
{% endblock %}
", "panier/index.html.twig", "C:\\Users\\miral\\OneDrive\\Bureau\\PidevRania\\templates\\panier\\index.html.twig");
    }
}
