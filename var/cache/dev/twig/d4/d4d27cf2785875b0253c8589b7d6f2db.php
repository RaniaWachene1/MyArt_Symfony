...
class __TwigTemplate_c2eb0406c1d25ab0d8b35165178b4dd6 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        <tbody>
            <tr>
                ...
                <td>";
        // line 12
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["galery"]) || array_key_exists("galery", $context) ? $context["galery"] : (function () { throw new RuntimeError('Variable "galery" does not exist.', 12, $this->source); })()), "idGalerie", [], "any", false, false, false, 12), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>TitreGalerie</th>
                <td>";
        // line 16
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["galery"]) || array_key_exists("galery", $context) ? $context["galery"] : (function () { throw new RuntimeError('Variable "galery" does not exist.', 16, $this->source); })()), "titreGalerie", [], "any", false, false, false, 16), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
{% endblock %}
", "galeries/show.html.twig", "C:\\Users\\rania\\my_project_directory\\templates\\galeries\\show.html.twig");
    }
}
