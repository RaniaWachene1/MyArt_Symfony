...
class ArticlesController extends AbstractController
{
    ...
    public function pdfcart(Panier $panier): Response
    {
        ...
        $sid = "ACfe2663d985cb8895aea4c93396a8c094"; // Your Account SID from www.twilio.com/console
        $token = "c9b2366dc01af0e676a505b885b268ec"; // Your Auth Token from www.twilio.com/console
        $description='Dear customer your command has been successfuly validated witch'.$panier->getTotal().'TND';
$description = 'Dear customer, your order has been successfully validated. The total amount to be charged is ' . $panier->getTotal() . ' TND. Your order will be shipped within 48 hours. Thank you for choosing MyArt!';

        $client = new Client($sid, $token);
        $message = $client->messages->create(
            '+21622600311', // Text this number
            [
                'from' => '+16813219518', // From a valid Twilio number
                'body' => $description
            ]
        );
